...
@register_operator(name='lensless_voronoi')
...
@register_operator(name='lensless_real_ys')
class PsfOperator(LinearOperator):
    def __init__(self,args, device, **kwargs) -> None:
        """
        parser = argparse.ArgumentParser()
        ...
        self.psf_512 = load_psf_real(args = self.args, psf_file = "./samples/dps_val/ys_flickr_100/psf/psf_camera1_original.tiff", resize_dim= 512).unsqueeze(0).cuda(GPU_NUM)
        self.psf_256 = load_psf(args = self.args, psf_file = "./samples/dps_val/ys_flickr_100/psf/psf_camera1_original.tiff", resize_dim= 256).unsqueeze(0).cuda(GPU_NUM)
...
@register_operator(name='lensless_real_waller')
class PsfOperator(LinearOperator):
    def __init__(self,args, device, **kwargs) -> None:
        """
        parser = argparse.ArgumentParser()
        ...
        self.psf_512 = load_psf_waller(args = self.args, psf_file = "./samples/dps_val/diffusercam_100/psf.tiff", resize_dim= 512).unsqueeze(0).cuda(GPU_NUM)
        self.psf_256 = load_psf_waller(args = self.args, psf_file = "./samples/dps_val/diffusercam_100/psf.tiff", resize_dim= 256).unsqueeze(0).cuda(GPU_NUM)
